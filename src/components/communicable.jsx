                            ...
                            <form onSubmit={(e) => handleSubmit(e, history) }>
                                    ...
                                    <div className="col-md-12">
                                        <div className="form-group">
                                            <div className="form-check">
                                                <input name="condition" className="form-check-input" type="radio" value="" id="defaultCheck1" />
                                ...
                                <div className="row">
                                    <div className="col-md-12">
                                        <div className="form-group">
                                            <div className="form-check">
                                                <input name="condition" className="form-check-input" type="radio" value="" id="defaultCheck2" />
                                ...
                                <div className="row">
                                    <div className="col-md-12">
                                        <div className="form-group">
                                            <div className="form-check">
                                                <input name="condition" className="form-check-input" type="radio" value="" id="defaultCheck3" />
